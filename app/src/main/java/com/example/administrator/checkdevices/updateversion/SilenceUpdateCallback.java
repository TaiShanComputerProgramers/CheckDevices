...
public class SilenceUpdateCallback extends UpdateCallback {
    @Override
    protected final void hasNewApp(final UpdateAppBean updateApp, final AppUpdateManager updateAppManager) {
        //添加信息
     ...
     */
    protected void showDialog(UpdateAppBean updateApp, AppUpdateManager updateAppManager, File appFile) {
