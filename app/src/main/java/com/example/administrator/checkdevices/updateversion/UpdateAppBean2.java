package com.example.administrator.checkdevices.updateversion;
 ...
 * 版本信息
 */
public class UpdateAppBean2 implements Serializable {
    ...
    public UpdateAppBean2 setConstraint(boolean constraint) {
    ...
    public UpdateAppBean2 setUpdate(String update) {
        this.update = update;
        return this;
    }
    ...
    public UpdateAppBean2 setNewVersion(String new_version) {
    ...
    public UpdateAppBean2 setApkFileUrl(String apk_file_url) {
    ...
    public UpdateAppBean2 setUpdateLog(String update_log) {
    ...
    public UpdateAppBean2 setUpdateDefDialogTitle(String updateDefDialogTitle) {
    ...
    public UpdateAppBean2 setNewMd5(String new_md5) {
    ...
    public UpdateAppBean2 setTargetSize(String target_size) {
    ...
    public UpdateAppBean2 setOriginRes(String originRes) {
