...
import com.example.administrator.checkdevices.interfaces.ExceptionHandler;
import com.example.administrator.checkdevices.interfaces.ExceptionHandlerHelper;
import com.example.administrator.checkdevices.interfaces.IUpdateDialogFragmentListener;
import com.example.administrator.checkdevices.updateversion.AppUpdateManager;
import com.example.administrator.checkdevices.updateversion.AppUpdateUtils;
import com.example.administrator.checkdevices.updateversion.ColorUtil;
import com.example.administrator.checkdevices.updateversion.DownloadService;
import com.example.administrator.checkdevices.updateversion.DrawableUtil;
...
//        getDialog().getWindow().addFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCH_MODAL);
    ...
    private void initData() {
        mUpdateApp = (UpdateAppBean) getArguments().getSerializable(AppUpdateManager.INTENT_KEY);
        //设置主题色
        initTheme();
    ...
    private void initTheme() {
        ...
        final int color = getArguments().getInt(AppUpdateManager.THEME_KEY, -1);

        final int topResId = getArguments().getInt(AppUpdateManager.TOP_IMAGE_KEY, -1);
